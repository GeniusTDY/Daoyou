...
#define CONFIGURE_ARGS " '--prefix=/tmp/offline-prefix/pg' '--without-readline' '--without-icu' '--without-ldap' '--without-pam' '--without-openssl' '--without-gssapi' '--without-libxml' '--without-libxslt' '--without-selinux' '--without-systemd' '--without-tcl' '--without-perl' '--without-python' '--without-zlib'"
...
#define PACKAGE_STRING "PostgreSQL 16.15"
