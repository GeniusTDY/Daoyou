 ...
 */
/*
 * ProjectionRules: affixprojectionPolicy
 * - skill SkillProjectionPolicymp/cooldown/priority/effects/targetPolicy
 * - / PassiveProjectionPolicylisteners  abilityTags
 *  AffixEffectTranslator  effect
 */
...
> {
  ...
  private buildSkillPolicy(
    ...
    for (const rolled of affixes) {
      ...
      if (!def) continue;
      //  rolled  translator finalMultiplier
...
/**
 *  count Fisher-Yates partial shuffle
 *  count >= arr.length
 */
