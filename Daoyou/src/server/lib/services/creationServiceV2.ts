...
/**
 * //
 *  CreationEngine.processRequest v2  creation_products
 */
export async function prepareCreation(
  ...
  // 5. “”dose
  //
  //  materialQuantities id  1..3
  
  //   -  1
  //   -  [minQuantityPerMaterial, maxQuantityPerMaterial]V2
  //   -
  //
  //  DB  quantity dose  orchestrator
  //  CreationInputValidator  > 3  400
  //  energyValue/dominantTags
